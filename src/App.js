...
class App extends Component {
    ...
    componentDidMount() {
        const endpoint = {
            ...
            happyTargetedWords: ['crafted', 'love', 'passionate about', 'dream', 'flexibility', 'visionary', 'makes a difference', 'dynamic', 'growing', 'committed', 'happy', 'dedicated', 'equal opportunity', 'state of the art', 'rare', 'unusual', 'value diversity', 'do not discriminate', 'improvements', 'improvement', 'creativity', 'build', 'ground-breaking', 'problem solver', 'crafting', 'craft', 'new technologies', 'data warehousing', 'improving', 'dedicatedly', 'initiative', 'new ideas', 'improve', 'mentoring', 'mentorship', 'fast growing', 'rapidly growing', 'dedicted', 'dedication', 'creative', 'high-energy', 'upbeat', 'a magical experience', 'a chance to create', 'a chance to', 'positive relationships', 'every single day', 'a real passion for', 'designing and maintaining', 'superb communication'],
            formalTargetedWords: ['must', 'ideal candidate', 'ought to', 'stakeholders', 'strategic thinking', 'the candidate', 'the applicant', 'successful applicants', 'candidates must be', 'ideally candidates', 'you must have', 'trouble shooting', 'escalation', 'candidates', 'a must', 'right candidate', 'on a daily basis', 'cross-functional', 'proactively', 'best practice', 'are managed', 'is properly monitored', 'comply with', 'you need to', 'KPI\'s', 'KPIs', 'buy in', 'project manager', 'connect with you']
        };
        const allWords = endpoint.maleTargetedWords.concat(endpoint.feminineTargetedWords).concat(endpoint.happyTargetedWords).concat(endpoint.formalTargetedWords);
